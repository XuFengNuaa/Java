...
<script type="text/javascript" src="/tsms/login/login.js"></script>
...
<table width="900" align="center" height="580" background="/tsms/web/inc/resources/images/custom/bg.jpg">
<tr>
	<td>&nbsp;</td>
</tr>
</table>
