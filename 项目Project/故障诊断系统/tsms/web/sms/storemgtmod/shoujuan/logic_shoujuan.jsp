...
<%@ page import="java.util.*,org.json.*,java.io.*,com.nuaa.sys.util.DbUtil,com.nuaa.sys.util.PublicUtil,java.util.UUID,java.sql.*,com.nuaa.sys.util.AppInsFactory,com.nuaa.app.ShouJuanMod"%>
...
<%
    ...
    String result=""; 
    ShouJuanMod pm=(ShouJuanMod)AppInsFactory.getBean("ShouJuanMod");
	...
	fileHashMap.put("id",request.getParameter("id"));
	System.out.println("2222222"+request.getParameter("id"));
