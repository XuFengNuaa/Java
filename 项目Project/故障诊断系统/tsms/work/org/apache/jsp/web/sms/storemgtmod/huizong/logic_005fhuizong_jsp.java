package org.apache.jsp.web.sms.storemgtmod.huizong;
...
public final class logic_005fhuizong_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	huizongMod um=(huizongMod)AppInsFactory.getBean("huizongMod");
	...
	try{
			...
			if(request.getParameter("people1")!=null){//责任人
				hashMap.put("people",request.getParameter("people1"));
			}
			if(request.getParameter("date1")!=null){
				hashMap.put("date",request.getParameter("date1"));
			}
			if(request.getParameter("problem1")!=null){
				hashMap.put("problem",request.getParameter("problem1"));
			}
			if(request.getParameter("reason1")!=null){
				hashMap.put("reason",request.getParameter("reason1"));
			}
			if(request.getParameter("solution1")!=null){
				hashMap.put("solution",request.getParameter("solution1"));
			}
			...
			if(request.getParameter("los_people")!=null){//零件编码
				hashMap.put("people",request.getParameter("los_people"));
			}
			if(request.getParameter("los_date")!=null){
				hashMap.put("date",request.getParameter("los_date"));
			}
			if(request.getParameter("los_problem")!=null){
				hashMap.put("problem",request.getParameter("los_problem"));
			}
			...
			if(request.getParameter("los_reason")!=null){
				hashMap.put("reason",request.getParameter("los_reason"));
			}
			if(request.getParameter("los_remark")!=null){
				hashMap.put("remark",request.getParameter("los_remark"));
			}
			if(request.getParameter("los_solution")!=null){
				hashMap.put("solution",request.getParameter("los_solution"));
			}
			System.out.println("ccccccccccc"+request.getParameter("los_solution"));
