...
Ext.extend(Ext.ux.UploadDialog.Dialog, Ext.Window, {
  ...
  createGrid : function()
  {
    ...
    var sm_bom=new Ext.grid.CheckboxSelectionModel();     ///////////
  ...
  fillToolbar : function()
  {
    ...
    //tb.x_buttons.browse = tb.addButton({               //////////////////
	//    text: "预览",
	//    tooltip: "预览动画",
	//    handler:this.show_animation,
	//    scope: this
    //});
  ...
  show_animation : function()          /////////////////////////////////
  {
	  ...
	  window.open("/tsms/web/tms/stepmod/showanimation.jsp?wid=browse&name="+encodeURI(record[0].get("filename")),'动画播放','height=600,width=800,toolbar=no,menubar=no,scrollbars=no,left='+left+',top='+top+',resizable=Yes,status=no,location=no');
  },	
...
var p=Ext.ux.UploadDialog.Dialog.prototype;
	...
	note_col_width:100,
	add_btn_text:"添加",
	add_btn_tip:"添加文件到导入队列。",
	remove_btn_text:"删除",
	remove_btn_tip:"从导入队列删除文件。",
	reset_btn_text:"重置",
	reset_btn_tip:"重置队列。",
	upload_btn_start_text:"开始导入",
	upload_btn_stop_text:"中断导入",
	upload_btn_start_tip:"导入文件对列。",
	upload_btn_stop_tip:"停止导入。",
	close_btn_text:"关闭",
	close_btn_tip:"关闭导入对话框。",
	progress_waiting_text:"等待...",
	progress_uploading_text:"导入中: {0} 的 {1} 文件集合成功。",
	error_msgbox_title:"错误",
	permitted_extensions_join_str:",",
	err_file_type_not_permitted:"不支持导入该类型文件.<br/>请选择下列类型的文件集合 {1}",
	note_queued_to_upload:"导入的队列。",
	note_processing:"导入中...",
	note_upload_failed:"当前请求过多，服务器正忙，不能及时响应或者因特网服务器发生错误。",
	note_upload_success:"导入成功。",
	note_upload_error:"导入文件出错。",
