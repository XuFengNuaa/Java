...
<%@page import="
org.json.JSONObject,com.nuaa.sys.util.AppInsFactory,com.nuaa.app.rfpzMod,
java.io.PrintWriter,
java.net.URLEncoder,
...
rfpzMod um = (rfpzMod)AppInsFactory.getBean("rfpzMod");
...
try{
	if("LOAD".equals(type)){
		...
		hashmap.put("mk",request.getParameter("mk"));
