Ext.onReady(function(){
				...
				items:[
					{
						   ...
						   items:[{xtype:'textfield',fieldLabel: '刷板',emptyText:'',id: 'ps3',width: 100}, 
						            ...
						            //{xtype:'textfield',fieldLabel: '',emptyText:'',labelhidden:true,id: 'sm3',hidden:true,width: 100},
						            //{xtype:'textfield',fieldLabel: '多层贴膜',emptyText:'',id: 'dc3',labelhidden:true,hidden:true,width: 100},
	...
	items: [{
		id:'cp',
	    region: 'center',
	    title:"<p align='center'>制样板规则维护(分钟)</p>",
	    border:false,	
	    frame: true,
	    layout:'fit',
	    items: rightborder
