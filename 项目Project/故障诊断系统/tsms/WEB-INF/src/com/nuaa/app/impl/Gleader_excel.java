	 ...
	 public void createExcelC(HashMap hashMap, OutputStream os) throws WriteException, IOException
	    {
	    	...
	    	String sql="";
	    	sql="select * from v_cut2hqapply where trim(gleader_approve)='未处理' and group_num in(select group_num from t_user where realname="+gleadername+")"; 
...
//		    	读取导出日期
		    	...
		    	//创建工作表�����µ�
				WritableSheet sheet = workbook.createSheet("高质新刀具借用班组长审批", 0);
//				标题存放格式设定
				...
				Label fname = new Label(0, 0, "标题：高质新刀具借用班组长审批",seat);
				sheet.addCell(fname);
...
//				创建要显示的具体内容的题头
				...
				Label Wname = new Label(6, 5, "姓名",center);
				sheet.addCell(Wname);
	 ...
	 public void createExcelCT(HashMap hashMap, OutputStream os) throws WriteException, IOException
	    {
		 	...
		 	final String gleadername="'"+(String)hashMap.get("gleadername")+"'";
	    	String sql="";
	    	sql="select * from v_ct2hqapply where trim(gleader_approve)='未处理' and group_num in(select group_num from t_user where realname="+gleadername+")";  
	    	final ArrayList pcArray=new ArrayList();
	    	try{
		    	DbUtil.execute(sql,new IResultSetProcessor() {
					public void process(ResultSet rs) throws SQLException {	
		    	...
		    	WritableWorkbook workbook = Workbook.createWorkbook(os);
		    	//创建工作表�����µ�
				WritableSheet sheet = workbook.createSheet("高质非测量工具借用班组长审批", 0);
//				内容存放格式设定
				WritableFont place = new WritableFont(WritableFont.ARIAL,11, WritableFont.BOLD, false);
				WritableCellFormat seat = new WritableCellFormat(place);
				//水平居中
...
//				内容存放格式设定
		        ...
		        //创建标题，导出时间及查询条件
				sheet.mergeCells(0, 0, 8, 0);
				Label fname = new Label(0, 0, "标题：高质非测量工具借用班组长审批",seat);
				sheet.addCell(fname);
	 ...
	 public void createExcelM(HashMap hashMap, OutputStream os) throws WriteException, IOException
	    {
		 	...
		 	final String gleadername="'"+(String)hashMap.get("gleadername")+"'";
	    	String sql="";
	    	sql="select * from v_m2hqmmt where trim(gleader_approve)='未处理' and group_num in(select group_num from t_user where realname="+gleadername+")";  
	    	final ArrayList pcArray=new ArrayList();
	    	try{
		    	DbUtil.execute(sql,new IResultSetProcessor() {
					public void process(ResultSet rs) throws SQLException {	
...
//		    	读取导出日期
		    	...
		    	WritableWorkbook workbook = Workbook.createWorkbook(os);
		    	//创建工作表�����µ�
				WritableSheet sheet = workbook.createSheet("高质量具借用班组长审批", 0);
//				内容存放格式设定
				WritableFont place = new WritableFont(WritableFont.ARIAL,11, WritableFont.BOLD, false);
				WritableCellFormat seat = new WritableCellFormat(place);
				//水平居中
...
//				内容存放格式设定
		        ...
		        //创建标题，导出时间及查询条件
				sheet.mergeCells(0, 0, 8, 0);
				Label fname = new Label(0, 0, "标题：高质量具借用班组长审批",seat);
				sheet.addCell(fname);
	 ...
	 public void createExcelMT(HashMap hashMap, OutputStream os) throws WriteException, IOException
	    {
		 	...
		 	final String gleadername="'"+(String)hashMap.get("gleadername")+"'";
	    	String sql="";
	    	sql="select * from v_mt2hqmmt where trim(gleader_approve)='未处理' and group_num in(select group_num from t_user where realname="+gleadername+")";  
	    	final ArrayList pcArray=new ArrayList();
	    	try{
		    	DbUtil.execute(sql,new IResultSetProcessor() {
					public void process(ResultSet rs) throws SQLException {	
...
//		    	读取导出日期
		    	...
		    	WritableWorkbook workbook = Workbook.createWorkbook(os);
		    	//创建工作表�����µ�
				WritableSheet sheet = workbook.createSheet("高质测量工具借用班组长审批", 0);
//				内容存放格式设定
				WritableFont place = new WritableFont(WritableFont.ARIAL,11, WritableFont.BOLD, false);
				WritableCellFormat seat = new WritableCellFormat(place);
				//水平居中
...
//				内容存放格式设定
		        ...
		        //创建标题，导出时间及查询条件
				sheet.mergeCells(0, 0, 8, 0);
				Label fname = new Label(0, 0, "标题：高质测量工具借用班组长审批",seat);
				sheet.addCell(fname);
