Ext.onReady(function(){
	...
	items: [{
		     ...
		     autoHeight:true,
		     layout:'form',
		     items:[{xtype:'textfield',fieldLabel: '每块时间(分钟)',emptyText:'',id: 'mk',width: 100}, 
		            {xtype:'textfield',fieldLabel: '准结时间',emptyText:'',id: 'zj',width: 100}]
			}],
	...
	items: [{
		id:'cp',
	    region: 'center',
	    title:"<p align='center'>热风平整规则维护</p>",
	    border:false,	
	    frame: true,
	    layout:'fit',
	    items: rightborder
	...
	function modifywFn(){
		...
		var mk = Ext.get("mk").dom.value.trim();
	...
	function successFn(result,request){
		...
		Ext.getCmp("mk").setValue(objtp.mk);
	}
