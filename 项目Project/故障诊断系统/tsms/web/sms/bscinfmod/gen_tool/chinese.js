Ext.onReady(function(){
    ...
    //调用数据库信息
	var hqObj={url:'logic_chinese.jsp',method: 'POST',extraParams:{type:'QUERYCH',params:{start:start,limit:limit},filter:filter}};
    ...
    ds.load(obj);
    var hqObjAni={url:'logic_chinese.jsp',method:'POST',extraParams:{}};
	...
	function getDialog1(){	
		...
		if (!dialog1) {
				dialog1 = new Ext.ux.UploadDialog.Dialog({
				  url: 'logic_chinese.jsp?type=uploadimg&special='+special,
				  reset_on_hide: false,
				  modal:true,
				  closable : false,   
		          collapsible : false,   
