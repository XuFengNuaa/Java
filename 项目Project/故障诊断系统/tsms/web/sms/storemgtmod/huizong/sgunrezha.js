...
var dt = new Date();
 ...
 var tempdt1 = dt1.format('Y-m-d');
	...
	var hpObj={url:'logic_huizong.jsp',method: 'POST',extraParams:{type:'QUERY',params:{start:start,limit:limit},filter:filter,pclassjs:"S辊（三辊）热轧机",bclassjs:bclassjs}};
