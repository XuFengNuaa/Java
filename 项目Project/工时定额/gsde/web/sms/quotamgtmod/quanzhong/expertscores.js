...
Ext.onReady(function(){
	...
	var featuredoc = [['1','孔'],['2','槽'],['3','腔'],['4','台阶'],['5','平面'],['6','侧壁'],['7','缺口'],['8','清角']];
  ...
  //定义分手选择面板弹出窗口
    ...
    //下一步函数
   		 function winShowFn(){
	    	var feature = featurecombox.getValue();
	    	if(feature == '孔'){
		    		var form_title = new Ext.Panel({     
		    	    	...
		    	    	items:[new Ext.Panel({html:'&nbsp;',width:'100',style: "margin:10,0,0,0"}),
		    	               new Ext.Panel({html:"<p align='center'>加工精度</p>",width:'50',style: "margin:10,0,0,0"}),
		    	               new Ext.Panel({html:"<p align='center'>材料牌号</p>",width:'50',style: "margin:10,0,0,0"}),
		    	               new Ext.Panel({html:"<p align='center'>孔径</p>",width:'50',style: "margin:10,0,0,0"}),
		    	               new Ext.Panel({html:"<p align='center'>孔深</p>",width:'50',style: "margin:10,0,0,0"})
		    	    	]
		    	    });
    	    var form_row1 = new Ext.Panel({     
    	    	...
    	    	layout:'table',
    	        layoutConfig: {columns: 5},
    	    	items:[new Ext.Panel({html:"<p align='right'>加工精度&nbsp;&nbsp;</p>",width:'100',style: "margin:0,0,0,0"}),
    	               {
    		...
    		var form_row2 = new Ext.Panel({     
    	    	...
    	    	layout:'table',
    	        layoutConfig: {columns: 5},
    	    	items:[new Ext.Panel({html:"<p align='right'>材料牌号&nbsp;&nbsp;</p>",width:'100',style: "margin:0,0,0,0"}),
    	               {
    	        		style : 'margin:0,10,0,4',
    		        	xtype:'textfield',
    		        	//hideLabel: true,
    	  ...
    	  var form_row3  = new Ext.Panel({     
    	    	...
    	    	layout:'table',
    	        layoutConfig: {columns: 5},
    	    	items:[new Ext.Panel({html:"<p align='right'>孔径&nbsp;&nbsp;</p>",width:'100',style: "margin:0,0,0,0"}),
    	               {
    	        		style : 'margin:0,10,0,4',
    		        	xtype:'textfield',
    		        	//hideLabel: true,
    		  ...
    		  var form_row4 = new Ext.Panel({     
    		    	...
    		    	layout:'table',
    		        layoutConfig: {columns: 5},
    		    	items:[new Ext.Panel({html:"<p align='right'>孔深&nbsp;&nbsp;</p>",width:'100',style: "margin:0,0,0,0"}),
    		               {
    		        		style : 'margin:0,10,0,4',
    			        	xtype:'textfield',
    			        	//hideLabel: true,
		...
		new Ext.Viewport({
    		...
    		var form_title = new Ext.Panel({     
    	    	...
    	    	items:[new Ext.Panel({html:'&nbsp;',width:'100',style: "margin:10,0,0,0"}),
    	               new Ext.Panel({html:"<p align='center'>加工精度</p>",width:'50',style: "margin:10,0,0,0"}),
    	               new Ext.Panel({html:"<p align='center'>材料牌号</p>",width:'50',style: "margin:10,0,0,0"}),
    	               new Ext.Panel({html:"<p align='center'>槽宽</p>",width:'50',style: "margin:10,0,0,0"}),
    	               new Ext.Panel({html:"<p align='center'>槽深</p>",width:'50',style: "margin:10,0,0,0"})
