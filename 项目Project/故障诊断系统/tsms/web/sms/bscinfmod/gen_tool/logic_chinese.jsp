...
try{
		if("uploadimg".equals(type)){
			...
			HashMap HashMapNew=sd.uploadFile(fileHashMap);
...
//			   nowtime=UUID.randomUUID().toString();
			...
			String returnValue = sd.delPart(hashMap);
