...
<%@page import="
org.json.JSONObject,com.nuaa.sys.util.AppInsFactory,com.nuaa.app.baofengMod,
java.io.PrintWriter,
java.net.URLEncoder,
...
baofengMod um = (baofengMod)AppInsFactory.getBean("baofengMod");
...
try{
	if("LOAD".equals(type)){
		...
		hashmap.put("jg",request.getParameter("jg"));
