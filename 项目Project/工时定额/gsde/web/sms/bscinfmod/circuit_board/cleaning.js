...
Ext.onReady(function(){
    ...
    var record_cleaning= Ext.data.Record.create([    		
    		{name:'id'},
			{name:'numn'},
			{name:'cleaner'},
    ...
    //定义查询结果页面
	var hpObj={url:'logic_cleaning.jsp',method: 'POST',extraParams:{}};
		        ...
		        columns: [sm,
		            {
			            ...
			            header: "清洗工艺",
			            width:120,
			            dataIndex: "cleaning_process",
			            sortable: true
		        	} ,{
			            header: "清洗工艺方法",
			            dataIndex: "cleaning_method",
			            width:100,
			            sortable: true
			        },{
			            header: "工时",
  ...
  var formpanel = new Ext.FormPanel({
       ...
       items: [
               {xtype: 'textfield',fieldLabel:"编&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码",width:210,name:"numn",id:"numn",allowBlank:false,blankText:"编码不能为空，请填写!"},
               {xtype: 'textfield',fieldLabel:"清洗&nbsp;&nbsp;&nbsp;剂",width:210,name:"cleaner",id:"cleaner"},
               {xtype: 'textfield',fieldLabel:"清洗工艺",width:210,name:"cleaning_process",id:"cleaning_process"},
               {xtype: 'textfield',fieldLabel:"工艺方法",width:210,name:"cleaning_method",id:"cleaning_method"},
               {xtype: 'textfield',fieldLabel:"工&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;时",width:210,name:"work_time",id:"work_time",regex:/^[0-9]*$/,regexText:'工时只能由数字组成！'}
               ]
		    });
	//定义弹出窗口
   ...
   //组装页面
	...
	function successFn(result,request){
		...
		win.findById("numn").setValue(objtp.numn);
		win.findById("cleaner").setValue(objtp.cleaner);
		win.findById("cleaning_process").setValue(objtp.cleaning_process);
		win.findById("cleaning_method").setValue(objtp.cleaning_method);
		win.findById("work_time").setValue(objtp.work_time);
	}
	  ...
	  function viewFn(){
			...
			if(record.length==0){
               ...
               win.setTitle("<p align='center'>工时信息明细</p>")
				...
				Ext.getCmp("company_type").getEl().dom.readOnly  = true;
