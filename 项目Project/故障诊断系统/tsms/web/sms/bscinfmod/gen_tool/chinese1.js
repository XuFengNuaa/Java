Ext.onReady(function(){
    ...
    //调用数据库信息
	var hqObj={url:'logic_chinese1.jsp',method: 'POST',extraParams:{type:'QUERYCH1',params:{start:start,limit:limit},filter:filter}};
    ...
    ds.load(obj);
    var hqObjAni={url:'logic_chinese1.jsp',method:'POST',extraParams:{}};
	...
	function getDialog1(){	
		...
		if (!dialog1) {
				dialog1 = new Ext.ux.UploadDialog.Dialog({
				  url: 'logic_chinese1.jsp?type=uploadimg1&special='+special,
				  reset_on_hide: false,
				  modal:true,
				  closable : false,   
		          collapsible : false,   
