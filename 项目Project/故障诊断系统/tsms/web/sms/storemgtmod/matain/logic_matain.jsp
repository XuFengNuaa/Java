...
<%@ page import="java.util.*,org.json.*,java.io.*,com.nuaa.sys.util.DbUtil,com.nuaa.sys.util.PublicUtil,java.util.UUID,java.sql.*,com.nuaa.sys.util.AppInsFactory,com.nuaa.app.MatainMod"%>
...
<%
    ...
    String result=""; 
    MatainMod pm=(MatainMod)AppInsFactory.getBean("MatainMod");
