...
import com.nuaa.app.StoreStatModCTEx;
import com.nuaa.sys.util.DbUtil;
import com.nuaa.sys.util.IResultSetProcessor;
import com.nuaa.sys.util.Logger;

public class StoreStatModCTExImpl implements StoreStatModCTEx {

	public void StoreStatModCT1Ex(HashMap hashMap, OutputStream os)
		...
		String sql="";
		sql="select * from ct_base where "+filter+" order by "+order+"";
		Logger.debug(sql);
...
//			创建标题，导出时间及查询条件
			...
			Label fname = new Label(0, 0, "标题：非测量类工具当前库存统计",seat);
			sheet.addCell(fname);
	...
	public void StoreStatModCT2Ex(HashMap hashMap, OutputStream os)
	throws WriteException, IOException {
// TODO 自动生成方法存根
System.out.println("filter="+(String)hashMap.get("filter"));
String filter=(String)hashMap.get("filter");
...
String result=(String)hashMap.get("result");
String sql="";
sql="select * from ct_entry where "+filter+" order by "+order+"";
Logger.debug(sql);
final ArrayList pcArray=new ArrayList();
try{
	DbUtil.execute(sql,new IResultSetProcessor() {
...
//	创建标题，导出时间及查询条件
	sheet.mergeCells(0, 0, 9, 0);
	Label fname = new Label(0, 0, "标题：非测量类工具入库历史记录",seat);
	sheet.addCell(fname);
	sheet.mergeCells(0, 1, 9, 1);
	Label ftime = new Label(0, 1, "导出日期："+CurDate,wordsize);
	sheet.addCell(ftime);
...
// TODO 自动生成 catch 块
	...
	public void StoreStatModCT3Ex(HashMap hashMap, OutputStream os)
	throws WriteException, IOException {
// TODO 自动生成方法存根
System.out.println("filter="+(String)hashMap.get("filter"));
String filter=(String)hashMap.get("filter");
...
String result=(String)hashMap.get("result");
String sql="";
sql="select * from ct_br_now where "+filter+" order by "+order+"";
Logger.debug(sql);
final ArrayList pcArray=new ArrayList();
try{
	DbUtil.execute(sql,new IResultSetProcessor() {
...
//	创建标题，导出时间及查询条件
	sheet.mergeCells(0, 0, 9, 0);
	Label fname = new Label(0, 0, "标题：非测量类工具当前借出记录",seat);
	sheet.addCell(fname);
	sheet.mergeCells(0, 1, 9, 1);
	Label ftime = new Label(0, 1, "导出日期："+CurDate,wordsize);
	sheet.addCell(ftime);
...
// TODO 自动生成 catch 块
	...
	public void StoreStatModCT4Ex(HashMap hashMap, OutputStream os)
	throws WriteException, IOException {
// TODO 自动生成方法存根
System.out.println("filter="+(String)hashMap.get("filter"));
String filter=(String)hashMap.get("filter");
...
String result=(String)hashMap.get("result");
String sql="";
sql="select * from ct_br_record where "+filter+" order by "+order+"";
Logger.debug(sql);
final ArrayList pcArray=new ArrayList();
try{
	DbUtil.execute(sql,new IResultSetProcessor() {
...
//	创建标题，导出时间及查询条件
	...
	Label fname = new Label(0, 0, "标题：非测量类工具借还历史记录",seat);
	sheet.addCell(fname);
...
// TODO 自动生成 catch 块
	...
	public void StoreStatModCT5Ex(HashMap hashMap, OutputStream os)
	throws WriteException, IOException {
// TODO 自动生成方法存根
System.out.println("filter="+(String)hashMap.get("filter"));
String filter=(String)hashMap.get("filter");
...
//	创建标题，导出时间及查询条件
	...
	Label fname = new Label(0, 0, "标题：非测量类工具借用频率统计",seat);
	sheet.addCell(fname);
