...
<script type="text/javascript" src="/casting/js/Function_menu.js"></script>
		...
		hideMode:'display',
	    	items:[
	    		new Ext.BoxComponent({
		            ...
		            layout:'accordion',
		            //hideMode:'display',	    		
		    		items:[Material_infor_panel,//材料信息
		                	Casting_infor_panel,//铸件信息
...
<body>
	<div id="contentIframe" >
		<iframe id="mainFrame" name="mainFrame" class="mainFrame" width="100%" height="100%" frameborder="0"></iframe>		
	</div>
	
	<div id="mainframehead">	
		<table id="mfb_table"  width="100%" height="100%" border="0" cellpadding="0" background="/casting/images/headback.jpg">
		<tr>
			<td width=680 height=45 background="/casting/images/head.png"/>
			<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
			<td valign="middle" >				
