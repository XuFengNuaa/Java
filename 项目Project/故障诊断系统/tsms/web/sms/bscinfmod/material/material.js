Ext.onReady(function(){
	...
	var grid = new Ext.grid.GridPanel({
        ...
        columns: [sm,
                   ...
                   {header: "故障率",width:80,align:'center',dataIndex: "maopiwidth_sim",sortable: true},
                   {header: "采用率",width: 80,align:'center',dataIndex: "maopihigh_sim",sortable: true}],
	...
	function customQueryFn(){
		...
		items:[search,
				...
				tbar:new Ext.Toolbar({ 
						items:[toolone,{id:'add-btn',text:"增加实例",handler:addFn,iconCls:"add"},
							...
							toolfour,{id:'pass-btn',text:"修改实例",handler: imgFn,iconCls:"add"},
		...
		function viewImgFn(){
	    	...
	    	var imgviewpanel=new Ext.FormPanel({
			    ...
			    html:'<img width=510 hight=1024 alt="案例详情" src="logicimgview.jsp?type=viewimg&tuhao_sim='+tuhao_sim+'"/>',
			    items: [{
			    buttons: [{
			     			id:'backbtn',
							text: '返回',
