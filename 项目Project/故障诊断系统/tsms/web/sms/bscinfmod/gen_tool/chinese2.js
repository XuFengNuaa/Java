Ext.onReady(function(){
    ...
    //调用数据库信息
	var hqObj={url:'logic_chinese2.jsp',method: 'POST',extraParams:{type:'QUERYCH2',params:{start:start,limit:limit},filter:filter}};
    ...
    ds.load(obj);
    var hqObjAni={url:'logic_chinese2.jsp',method:'POST',extraParams:{}};
					...
					fn:function(btn){					              
						if (btn=='ok'){	
						   Ext.showProgressDialog();							
							...
							Ext.Ajax.request({
						   	url: 'logic_chinese2.jsp',
						   	params: {type:'DEL2',id:id1},
	...
	function getDialog1(){	
		...
		if (!dialog1) {
				dialog1 = new Ext.ux.UploadDialog.Dialog({
				  url: 'logic_chinese2.jsp?type=uploadimg2&special='+special,
				  reset_on_hide: false,
				  modal:true,
				  closable : false,   
		          collapsible : false,   
