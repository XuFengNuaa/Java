Ext.onReady(function(){
	...
	var grid = new Ext.grid.GridPanel({
					        ...
					        columns: [sm,
					       {
							...
							tbar:new Ext.Toolbar({ 
									height:26,
									items:
									[{ id:'assess1',iconCls:"update",text:"下载申请", handler: weightcalFn1}]
								})
    ...
    var grid_In = new Ext.grid.GridPanel({
							...
							tbar:new Ext.Toolbar({ 
									height:26,
									items:
									[{ id:'assess',iconCls:"update",text:"答疑", handler: weightcalFn}]
								})
	});				       
	...
	*/
	...
	function weightcalFn1(){
		var m = Ext.getCmp("grid").getStore().getCount();
		if(m==0){
			alert( "提示:请至少选择一条记录!");
			return;
		}
