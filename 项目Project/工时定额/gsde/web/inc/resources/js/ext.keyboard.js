...
Ext.KeyBoard = Ext.extend(Ext.Panel, {
    ...
    */
    ...
    initComponent : function(){
        Ext.KeyBoard.superclass.initComponent.call(this);
        this.addEvents(
            /**
             * @event activate
             * Fires after the window has been visually activated via {@link setActive}.
             * @param {Ext.KeyBoard} this
             */
            /**
             * @event deactivate
    ...
    // private
    getState : function(){
        return Ext.apply(Ext.KeyBoard.superclass.getState.call(this) || {}, this.getBox());
    },

    // private
    onRender : function(ct, position){
        Ext.KeyBoard.superclass.onRender.call(this, ct, position);
    ...
    // private
    initEvents : function(){
        Ext.KeyBoard.superclass.initEvents.call(this);
    ...
    initDraggable : function(){
        this.dd = new Ext.KeyBoard.DD(this);  
    },
   ...
   // private
    ...
    beforeDestroy : function(){
        ...
        Ext.KeyBoard.superclass.beforeDestroy.call(this);
    },
    ...
    onDestroy : function(){
        ...
        Ext.KeyBoard.superclass.onDestroy.call(this);
    },
...
Ext.reg('keyboard', Ext.KeyBoard);

// private - custom KeyBoard DD implementation
Ext.KeyBoard.DD = function(win){
    this.win = win;
    Ext.KeyBoard.DD.superclass.constructor.call(this, win.el.id, 'WindowDD-'+win.id);
    this.setHandleElId(win.header.id);
    this.scroll = false;
};

Ext.extend(Ext.KeyBoard.DD, Ext.dd.DD, {
    moveOnly:true,
