...
<%@page import="
org.json.JSONObject,com.nuaa.sys.util.AppInsFactory,com.nuaa.app.kongjinshuhuaMod,
java.io.PrintWriter,
java.net.URLEncoder,
...
<%
	...
	kongjinshuhuaMod um=(kongjinshuhuaMod)AppInsFactory.getBean("kongjinshuhuaMod");
