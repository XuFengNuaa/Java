...
public class LoginImpl implements Login {
	...
	public String getUserInf(String userid){
		String sql="select stuff_num, realname,remark,group_num,userlevel from v_user2role where stuff_num='"+userid+"'";
	...
	public boolean checkSession(HttpServletRequest req,HttpServletResponse resp) {
		...
		if (requestURI.equals("/login/login.jsp")|| requestURI.equals("/login/logiclogin.jsp")){
			System.out.println("URL符合要求");
			return true;
		}
		if (session!= null && session.getAttribute("userlevel") != null){
